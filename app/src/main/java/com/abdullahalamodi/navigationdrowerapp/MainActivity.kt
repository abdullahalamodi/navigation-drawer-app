package com.abdullahalamodi.navigationdrowerapp
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var activity_main_toolbar: Toolbar;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity_main_toolbar = findViewById(R.id.toolbar)
        ...
        updateActionBarTitle("homeFragment");
            ...
            override fun onClick(view: View, position: Int) {
                when (position) {
                    ...
                    1 -> {
                        ...
                        updateActionBarTitle("musicFragment");
                    }
                    2 -> {
                        // # Movies Fragment
                        ...
                        updateActionBarTitle("moviesFragment")
                    }
                    3 -> {
                        // # Books Fragment
                        ...
                        updateActionBarTitle("booksFragment")
                    }
                    4 -> {
                        // # Profile Activity
...
//                        startActivity(intent)
                    ...
                    5 -> {
                        ...
                        updateActionBarTitle("settingsFragment");
                    }
                    6 -> {
                        // # Open URL in browser
